  ...
  const fetchLoans = async (e) => {
    try {
      ...
      const { data } = await axios.get(
        `${import.meta.env.VITE_BASE_URL}/api/loan/get-group/${loanId}`
      );
      if (data) {
        console.log("Group Loan Data : ", data.loan);
        setLoan(data.loan);
        setLoading(false);
      }
      fetchEmis();
  ...
  const fetchEmis = async () => {
    try {
      const { data: emis } = await axios.get(
        `${import.meta.env.VITE_BASE_URL}/api/loan/group-emis/${loanId}`
      );
      if (emis) {
        console.log("Group Emis : ", emis.emis);
